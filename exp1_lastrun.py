...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\keerb\\Downloads\\psychology\\exp1_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        ...
        languageStyle='LTR',
        depth=-1.0);
    sound_1 = sound.Sound('C:/Users/keerb/Downloads/project/project/audio/set_0/beat_en-IN-Standard-C.wav', secs=2, stereo=True, hamming=True,
        name='sound_1')
    sound_1.setVolume(1.0)
    key_resp = keyboard.Keyboard()
    text_3 = visual.TextStim(win=win, name='text_3',
        text='Did you observe latency, \nPress Y for yes, N for no',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    sound_1.setSound('C:/Users/keerb/Downloads/project/project/audio/set_0/beat_en-IN-Standard-C.wav', secs=2, hamming=True)
    ...
    trailComponents = [text, text_2, sound_1, key_resp, text_3]
    ...
    while continueRoutine:
        ...
        if sound_1.status == NOT_STARTED and tThisFlip >= 2.1-frameTolerance:
            # keep track of start time/frame for later
